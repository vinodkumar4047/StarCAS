...
export default [
  ...
  { path: 'authorizeEcomsite', component: AuthorizeEcomsiteComponent },
  ...
  { path: 'Authorize_Delete_MCC', component: AuthorizeDeleteMCCComponent },
  { path: 'add_mcc', component: AddMccComponent },
  { path: 'authorize_MCCC', component: AuthorizeMCCComponent },
